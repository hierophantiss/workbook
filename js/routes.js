    ...
    steps: [
      {
        ...
        options: [
          ...
          { mood: 'panic', category: 'crisis' },
          { mood: 'anxiety', category: 'tension' },
          { mood: 'restless', category: 'tension' },
          { mood: 'scattered', category: 'attention' },
          { mood: 'hyperfocus', category: 'attention' },
          { mood: 'numb', category: 'emotional' },
          { mood: 'selfcritical', category: 'emotional' },
          { mood: 'curious', category: 'positive' },
          { mood: 'energetic', category: 'positive' },
          { mood: 'calm', category: 'positive' },
          { mood: 'sleepy', category: 'neutral' }
        ],
        next: 'route_by_mood'
      },
      {
...
var MOOD_CATEGORIES = {
  crisis:    { el: 'Κρίση',       en: 'Crisis',     color: '#E24B4A', moods: ['overwhelm', 'panic'] },
  tension:   { el: 'Ένταση',      en: 'Tension',    color: '#C07050', moods: ['anxiety', 'restless'] },
  attention: { el: 'Προσοχή',     en: 'Attention',  color: '#C8922A', moods: ['scattered', 'hyperfocus'] },
  emotional: { el: 'Συναίσθημα',  en: 'Emotional',  color: '#B5A7D0', moods: ['numb', 'selfcritical'] },
  positive:  { el: 'Θετικό',      en: 'Positive',   color: '#7A9E7E', moods: ['curious', 'energetic', 'calm'] },
  neutral:   { el: 'Ουδέτερο',    en: 'Neutral',    color: '#2A5D5E', moods: ['sleepy'] }
};
