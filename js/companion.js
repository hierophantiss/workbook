...
function showCompanionBubble() {
  ...
  var smartActionsHtml = 
    '<button class="comp-smart-btn" onclick="hideCompanionBubble(); window.c2OpenFlow(\'moodCheck\');">💭 ' + (lang === 'el' ? 'Πώς νιώθεις;' : 'How do you feel?') + '</button>' +
    '<button class="comp-smart-btn" onclick="hideCompanionBubble(); window.c2OpenFlow(\'smartHub\');">🧭 ' + (lang === 'el' ? 'Τι να κάνω;' : 'What to do?') + '</button>';
