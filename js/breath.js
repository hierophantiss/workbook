...
function bUpdateVoiceBtn() {
  ...
  btn.style.color = bVoiceEnabled ? 'rgba(168,213,220,0.95)' : 'rgba(168,213,220,0.4)';
  btn.style.borderColor = bVoiceEnabled ? 'rgba(168,213,220,0.7)' : 'rgba(168,213,220,0.2)';
  btn.style.background = bVoiceEnabled ? 'rgba(70,110,115,0.6)' : 'rgba(0,0,0,0.5)';
...
function bUpdateMainControls() {
  ...
  if (playBtn) {
    ...
    if (iconEl && textEl) {
      ...
      textEl.textContent = bRunning ? ui.pause : ui.play;
    }
  }
