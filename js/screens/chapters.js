...
function buildChaptersList() {
  ...
  screen.innerHTML = `
    <div class="scroll-area">
      ...
      <div style="padding:8px 16px 0">
        <div class="content-card" style="margin:0; background:rgba(200,146,42,0.04); border:1px solid rgba(200,146,42,0.15)">
          <div style="display:flex; justify-content:space-between; align-items:center">
            ...
            <button class="btn-primary" onclick="requestNotifPermission()" style="padding:8px 14px; font-size:12px; min-height:auto">
