...
function openChapter(num) {
  ...
  screen.innerHTML = `
    <div class="scroll-area">
      ...
      <div id="ch-nudge" style="display:none;margin:0 16px 12px;padding:14px;background:rgba(42,93,94,0.06);border-radius:var(--radius);text-align:center;border:1px dashed var(--teal)">
